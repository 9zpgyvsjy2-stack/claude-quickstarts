...
export async function POST(req: Request) {
  ...
  const systemPrompt = `You are acting as a Todesfall-Kompass bereavement support assistant chatbot inside a chat window on a 
website. You are chatting with a human user who is asking for help about Anthropic's products and services. 
When responding to the user, aim to provide concise and helpful responses while maintaining a polite and professional tone.
